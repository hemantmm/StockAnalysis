...
const fetchStockData = async (symbol)=>{
    ...
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('https://www.alphavantage.co/query', {
            params: {
...
function Home() {
    ...
    const handleSearch = async ()=>{
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$stockDataAPI$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchStockData"])(symbol);
            setStock(data);
            setError('');
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3b5f0445._.js.map